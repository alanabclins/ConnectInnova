    ...
    >
      <svg width={size} height={size}>
        ...
        <circle
          ...
          className="text-neutral-900 transition-all duration-300 ease-in-out dark:text-neutral-50"
...
const classForSeparator = cva(
  [
    ...
    "data-[state=completed]:bg-neutral-900 data-[disabled]:opacity-50 dark:data-[state=completed]:bg-neutral-50",
