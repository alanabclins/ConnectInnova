...
const CircleFilled = ({
  ...
  <div className="relative" style={{ width: size, height: size }}>
    <div className="absolute inset-0 rotate-180">
      <LoaderCircleIcon
        className={cn('animate-spin', className, 'text-neutral-950 opacity-20 dark:text-neutral-50')}
        size={size}
        {...props}
      />
    </div>
...
const Infinite = ({ size = 24, ...props }: SpinnerVariantProps) => (
  ...
  >
    <title>Loading...</title>
    <path
      d="M24.3 30C11.4 30 5 43.3 50s6.4 20 19.3 20c19.3 0 32.1-40 51.4-40 C88.6 95 50s-6.4 20-19.3 20C56.4 70 43.6 24.3 30z"
      fill="none"
      stroke="currentColor"
