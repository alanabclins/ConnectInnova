...
async def analyze_project(project_uuid: UUID):
    ...
    fb_clarity_level = criteria_eval_data.get("proposta_de_valor", {}).get("level", None)
    fb_innovation = criteria_eval_data.get("originalidade", {}).get("feedback", "")
    fb_innovation_level = criteria_eval_data.get("originalidade", {}).get("level", None)
    fb_social = criteria_eval_data.get("impacto_social_ambiental", {}).get("feedback", "")
    fb_social_level = criteria_eval_data.get("impacto_social_ambiental", {}).get(
        "level", None
    )
    fb_viability = criteria_eval_data.get("sustentabilidade", {}).get("feedback", "")
    fb_viability_level = criteria_eval_data.get("sustentabilidade", {}).get("level", None)
    fb_potential = criteria_eval_data.get("escalabilidade", {}).get("feedback", "")
    fb_potencial_level = criteria_eval_data.get("escalabilidade", {}).get("level", None)
