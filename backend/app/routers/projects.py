...
async def create_project(
    ...
    try:
        ...
        if not clarity_problem_text and (project.problem_description or project.target_audience or project.value_proposition):
            parts = []
        ...
        if not tec_eco_viability_text and (project.technical_feasibility or project.revenue_model or project.scalability):
            parts = []
        ...
        if not application_potencial_text and (project.customer_segment or project.competitive_advantage):
            parts = []
